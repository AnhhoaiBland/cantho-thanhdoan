                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="/admin/baidangthanhdoan/edit/<?= $post['news_id'] ?>" class="btn btn-warning btn-sm">Chỉnh Sửa</a>
                                    <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete('/admin/baidangthanhdoan/delete/<?= $post['news_id'] ?>', event)">Xóa</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
    ...
    <nav aria-label="Page navigation" class="mt-3">
        <ul class="pagination justify-content-center">
            <?php if ($currentPage > 1): ?>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('/admin/baidangthanhdoan/' . ($currentPage - 1)) ?>">Previous</a>
                </li>
            <?php endif; ?>
            ...
            <?php if ($endPage < $totalPages): ?>
                ...
                <?php endif; ?>
                <li class="page-item">
                    <a class="page-link" href="<?= base_url('/admin/baidangthanhdoan/' . $totalPages) ?>"><?= $totalPages ?></a>
                </li>
            <?php endif; ?>
