<!-- Modal -->
<div id="modaladdlnd" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <form action="admin/addloainguoidung" method="POST" id="formaddloaind">
    <!-- Modal content-->
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" form="formaddloaind" class="btn btn-success">Thêm</button>
