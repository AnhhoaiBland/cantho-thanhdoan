...
.dataTables_paginate .pagination li.disabled a {
    color: #ccc;
    /* Màu sắc của các nút vô hiệu hóa */
    background-color: #f1f1f1;
    border-color: #ddd;
    pointer-events: none;
    /* Không cho phép nhấn vào */
}

/* Tùy chỉnh màu nền của container pagination */
.dataTables_paginate .pagination {
    background-color: #fff;
    /* Màu nền của vùng chứa pagination */
    border: 1px solid #ddd;
    /* Viền ngoài của vùng chứa pagination */
    border-radius: 4px;
    padding: 10px;
}
        ...
        <table class="table table-bordered" id="datatable">
			...
			foreach ($ds_baidang as $baiviet) : ?>
                <tr data-id="<?= $baiviet['maBaiDang'] ?>">
                    ...
                    <td>
                        <a href="admin/show_bai_vietAdmin/<?= $baiviet['maBaiDang'] ?>"> <?= $baiviet['tieuDe'] ?> </a>
                    </td>
