                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">Công tác giáo dục</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="../../../public/assets/images/news-700x435-3.jpg" style="object-fit: cover;">
                            ...
                            <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle mr-2" src="../../../public/assets/images/user.jpg" width="25" height="25" alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="position-relative mb-3">
                            <img class="img-fluid w-100" src="../../../public/assets/images/news-700x435-4.jpg" style="object-fit: cover;">
                            <div class="bg-white border border-top-0 p-4">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="">Business</a>
                                    <a class="text-body" href=""><small>Jan 01, 2045</small></a>
                    ...
                    <div class="col-lg-12 mb-3">
                        <a href=""><img class="img-fluid w-100" src="../../../public/assets/images/ads-728x90.png" alt=""></a>
                    </div>

                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">Hoạt động thanh niên</h4>
                            <a class="text-secondary font-weight-medium text-decoration-none" href="">View All</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row news-lg mx-0 mb-3">
                            <div class="col-md-6 h-100 px-0">
                                <img class="img-fluid h-100" src="../../../public/assets/images/news-700x435-5.jpg" style="object-fit: cover;">
                            </div>
